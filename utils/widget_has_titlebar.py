...
if __name__ == '__main__':
    ...
    print(f'Widget with title bar: {widgetHasTitlebar(widget_with_titlebar)}')  # Should print True
    print(f'Widget without title bar: {widgetHasTitlebar(widget_without_titlebar)}')  # Should print False
